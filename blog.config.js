...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || ' QIM', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的涩涩人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-87ux-git-main-moliyys-projects.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '绮梦小屋,比翼小屋', // 网站关键词 英文逗号隔开
